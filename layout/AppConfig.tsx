...
const AppConfig = (props: AppConfigProps) => {
    ...
    return (
        <>
            ...
            {/*                <img src="/public/layout/images/themes/bootstrap4-light-blue.svg" className="w-2rem h-2rem" alt="Bootstrap Light Blue" />*/}
            {/*            </button>*/}
            {/*        </div>*/}
            {/*        <div className="col-3">*/}
            {/*            <button className="p-link w-2rem h-2rem" onClick={() => changeTheme('bootstrap4-light-purple', 'light')}>*/}
            {/*                <img src="/public/layout/images/themes/bootstrap4-light-purple.svg" className="w-2rem h-2rem" alt="Bootstrap Light Purple" />*/}
            {/*            </button>*/}
            {/*        </div>*/}
            {/*        <div className="col-3">*/}
            {/*            <button className="p-link w-2rem h-2rem" onClick={() => changeTheme('bootstrap4-dark-blue', 'dark')}>*/}
            {/*                <img src="/public/layout/images/themes/bootstrap4-dark-blue.svg" className="w-2rem h-2rem" alt="Bootstrap Dark Blue" />*/}
            {/*            </button>*/}
            {/*        </div>*/}
            {/*        <div className="col-3">*/}
            {/*            <button className="p-link w-2rem h-2rem" onClick={() => changeTheme('bootstrap4-dark-purple', 'dark')}>*/}
            {/*                <img src="/public/layout/images/themes/bootstrap4-dark-purple.svg" className="w-2rem h-2rem" alt="Bootstrap Dark Purple" />*/}
            {/*            </button>*/}
            {/*        </div>*/}
            {/*    </div>*/}
            ...
            {/*                <img src="/public/layout/images/themes/md-light-indigo.svg" className="w-2rem h-2rem" alt="Material Light Indigo" />*/}
            {/*            </button>*/}
            {/*        </div>*/}
            {/*        <div className="col-3">*/}
            {/*            <button className="p-link w-2rem h-2rem" onClick={() => changeTheme('md-light-deeppurple', 'light')}>*/}
            {/*                <img src="/public/layout/images/themes/md-light-deeppurple.svg" className="w-2rem h-2rem" alt="Material Light DeepPurple" />*/}
            {/*            </button>*/}
            {/*        </div>*/}
            {/*        <div className="col-3">*/}
            {/*            <button className="p-link w-2rem h-2rem" onClick={() => changeTheme('md-dark-indigo', 'dark')}>*/}
            {/*                <img src="/public/layout/images/themes/md-dark-indigo.svg" className="w-2rem h-2rem" alt="Material Dark Indigo" />*/}
            {/*            </button>*/}
            {/*        </div>*/}
            {/*        <div className="col-3">*/}
            {/*            <button className="p-link w-2rem h-2rem" onClick={() => changeTheme('md-dark-deeppurple', 'dark')}>*/}
            {/*                <img src="/public/layout/images/themes/md-dark-deeppurple.svg" className="w-2rem h-2rem" alt="Material Dark DeepPurple" />*/}
            {/*            </button>*/}
            {/*        </div>*/}
            {/*    </div>*/}
            ...
            {/*                <img src="/public/layout/images/themes/md-light-deeppurple.svg" className="w-2rem h-2rem" alt="Material Light Deep Purple" />*/}
            {/*            </button>*/}
            {/*        </div>*/}
            {/*        <div className="col-3">*/}
            ...
            {/*                <img src="/public/layout/images/themes/md-dark-deeppurple.svg" className="w-2rem h-2rem" alt="Material Dark Deep Purple" />*/}
            {/*            </button>*/}
            {/*        </div>*/}
            {/*    </div>*/}
            ...
            {/*                <img src="/public/layout/images/themes/tailwind-light.png" className="w-2rem h-2rem" alt="Tailwind Light" />*/}
            {/*            </button>*/}
            {/*        </div>*/}
            {/*    </div>*/}
            ...
            {/*                <img src="/public/layout/images/themes/fluent-light.png" className="w-2rem h-2rem" alt="Fluent Light" />*/}
            {/*            </button>*/}
            {/*        </div>*/}
            {/*    </div>*/}
            ...
            {/*                <img src="/public/layout/images/themes/lara-light-indigo.png" className="w-2rem h-2rem" alt="Lara Light Indigo" />*/}
            {/*            </button>*/}
            {/*        </div>*/}
            {/*        <div className="col-3">*/}
            {/*            <button className="p-link w-2rem h-2rem" onClick={() => changeTheme('lara-light-blue', 'light')}>*/}
            {/*                <img src="/public/layout/images/themes/lara-light-blue.png" className="w-2rem h-2rem" alt="Lara Light Blue" />*/}
            {/*            </button>*/}
            {/*        </div>*/}
            {/*        <div className="col-3">*/}
            {/*            <button className="p-link w-2rem h-2rem" onClick={() => changeTheme('lara-light-purple', 'light')}>*/}
            {/*                <img src="/public/layout/images/themes/lara-light-purple.png" className="w-2rem h-2rem" alt="Lara Light Purple" />*/}
            {/*            </button>*/}
            {/*        </div>*/}
            {/*        <div className="col-3">*/}
            {/*            <button className="p-link w-2rem h-2rem" onClick={() => changeTheme('lara-light-teal', 'light')}>*/}
            {/*                <img src="/public/layout/images/themes/lara-light-teal.png" className="w-2rem h-2rem" alt="Lara Light Teal" />*/}
            {/*            </button>*/}
            {/*        </div>*/}
            {/*        <div className="col-3">*/}
            {/*            <button className="p-link w-2rem h-2rem" onClick={() => changeTheme('lara-dark-indigo', 'dark')}>*/}
            {/*                <img src="/public/layout/images/themes/lara-dark-indigo.png" className="w-2rem h-2rem" alt="Lara Dark Indigo" />*/}
            {/*            </button>*/}
            {/*        </div>*/}
            {/*        <div className="col-3">*/}
            {/*            <button className="p-link w-2rem h-2rem" onClick={() => changeTheme('lara-dark-blue', 'dark')}>*/}
            {/*                <img src="/public/layout/images/themes/lara-dark-blue.png" className="w-2rem h-2rem" alt="Lara Dark Blue" />*/}
            {/*            </button>*/}
            {/*        </div>*/}
            {/*        <div className="col-3">*/}
            {/*            <button className="p-link w-2rem h-2rem" onClick={() => changeTheme('lara-dark-purple', 'dark')}>*/}
            {/*                <img src="/public/layout/images/themes/lara-dark-purple.png" className="w-2rem h-2rem" alt="Lara Dark Purple" />*/}
            {/*            </button>*/}
            {/*        </div>*/}
            {/*        <div className="col-3">*/}
            {/*            <button className="p-link w-2rem h-2rem" onClick={() => changeTheme('lara-dark-teal', 'dark')}>*/}
            {/*                <img src="/public/layout/images/themes/lara-dark-teal.png" className="w-2rem h-2rem" alt="Lara Dark Teal" />*/}
            {/*            </button>*/}
            {/*        </div>*/}
            {/*    </div>*/}
            ...
            {/*                <img src="/public/layout/images/themes/saga-blue.png" className="w-2rem h-2rem" alt="Saga Blue" />*/}
            {/*            </button>*/}
            {/*        </div>*/}
            {/*        <div className="col-3">*/}
            {/*            <button className="p-link w-2rem h-2rem" onClick={() => changeTheme('saga-green', 'light')}>*/}
            {/*                <img src="/public/layout/images/themes/saga-green.png" className="w-2rem h-2rem" alt="Saga Green" />*/}
            {/*            </button>*/}
            {/*        </div>*/}
            {/*        <div className="col-3">*/}
            {/*            <button className="p-link w-2rem h-2rem" onClick={() => changeTheme('saga-orange', 'light')}>*/}
            {/*                <img src="/public/layout/images/themes/saga-orange.png" className="w-2rem h-2rem" alt="Saga Orange" />*/}
            {/*            </button>*/}
            {/*        </div>*/}
            {/*        <div className="col-3">*/}
            {/*            <button className="p-link w-2rem h-2rem" onClick={() => changeTheme('saga-purple', 'light')}>*/}
            {/*                <img src="/public/layout/images/themes/saga-purple.png" className="w-2rem h-2rem" alt="Saga Purple" />*/}
            {/*            </button>*/}
            {/*        </div>*/}
            {/*        <div className="col-3">*/}
            {/*            <button className="p-link w-2rem h-2rem" onClick={() => changeTheme('vela-blue', 'dark')}>*/}
            {/*                <img src="/public/layout/images/themes/vela-blue.png" className="w-2rem h-2rem" alt="Vela Blue" />*/}
            {/*            </button>*/}
            {/*        </div>*/}
            {/*        <div className="col-3">*/}
            {/*            <button className="p-link w-2rem h-2rem" onClick={() => changeTheme('vela-green', 'dark')}>*/}
            {/*                <img src="/public/layout/images/themes/vela-green.png" className="w-2rem h-2rem" alt="Vela Green" />*/}
            {/*            </button>*/}
            {/*        </div>*/}
            {/*        <div className="col-3">*/}
            {/*            <button className="p-link w-2rem h-2rem" onClick={() => changeTheme('vela-orange', 'dark')}>*/}
            {/*                <img src="/public/layout/images/themes/vela-orange.png" className="w-2rem h-2rem" alt="Vela Orange" />*/}
            {/*            </button>*/}
            {/*        </div>*/}
            {/*        <div className="col-3">*/}
            {/*            <button className="p-link w-2rem h-2rem" onClick={() => changeTheme('vela-purple', 'dark')}>*/}
            {/*                <img src="/public/layout/images/themes/vela-purple.png" className="w-2rem h-2rem" alt="Vela Purple" />*/}
            {/*            </button>*/}
            {/*        </div>*/}
            {/*        <div className="col-3">*/}
            {/*            <button className="p-link w-2rem h-2rem" onClick={() => changeTheme('arya-blue', 'dark')}>*/}
            {/*                <img src="/public/layout/images/themes/arya-blue.png" className="w-2rem h-2rem" alt="Arya Blue" />*/}
            {/*            </button>*/}
            {/*        </div>*/}
            {/*        <div className="col-3">*/}
            {/*            <button className="p-link w-2rem h-2rem" onClick={() => changeTheme('arya-green', 'dark')}>*/}
            {/*                <img src="/public/layout/images/themes/arya-green.png" className="w-2rem h-2rem" alt="Arya Green" />*/}
            {/*            </button>*/}
            {/*        </div>*/}
            {/*        <div className="col-3">*/}
            {/*            <button className="p-link w-2rem h-2rem" onClick={() => changeTheme('arya-orange', 'dark')}>*/}
            {/*                <img src="/public/layout/images/themes/arya-orange.png" className="w-2rem h-2rem" alt="Arya Orange" />*/}
            {/*            </button>*/}
            {/*        </div>*/}
            {/*        <div className="col-3">*/}
            {/*            <button className="p-link w-2rem h-2rem" onClick={() => changeTheme('arya-purple', 'dark')}>*/}
            {/*                <img src="/public/layout/images/themes/arya-purple.png" className="w-2rem h-2rem" alt="Arya Purple" />*/}
            {/*            </button>*/}
            {/*        </div>*/}
            {/*    </div>*/}
            {/*</Sidebar>*/}
