		...
		<div className="grid">
				...
				<div className="card mb-0">
					<div className="flex justify-content-between mb-3">
						<div>
							...
							<div className="text-900 font-medium text-xl">AED2.100</div>
						</div>
						<div
			...
			<div className="col-12 xl:col-6">
                ...
                <span className="text-900 font-medium mr-2 mb-1 md:mb-0">
                 Organic India Tulsi Breakfast Tea Bag 18
                </span>
								<div className="mt-1 text-600">AED 97.65123 AED</div>
							</div>
						...
						<li className="flex flex-column md:flex-row md:align-items-center md:justify-content-between mb-4">
							<div>
                <span className="text-900 font-medium mr-2 mb-1 md:mb-0">
                  Organic India Tulsi Masala Chai Tea Bag
                </span>
								<div className="mt-1 text-600">AED 78.75</div>
							</div>
						...
						<li className="flex flex-column md:flex-row md:align-items-center md:justify-content-between mb-4">
							<div>
                <span className="text-900 font-medium mr-2 mb-1 md:mb-0">
                  Nature Answer Licorice Root 2000 mg Fluid Extract Drops 30 mL
                </span>
								<div className="mt-1 text-600">AED 27.30123</div>
							</div>
							<div className="mt-2 md:mt-0 ml-0 md:ml-8 flex align-items-center">
								<div
									className="surface-300 border-round overflow-hidden w-10rem lg:w-6rem"
						...
						<li className="flex flex-column md:flex-row md:align-items-center md:justify-content-between mb-4">
							<div>
                <span className="text-900 font-medium mr-2 mb-1 md:mb-0">
	                Country Life Maxi-Zyme Extra Strength Capsules 60
                </span>
                ...
                <span className="text-900 font-medium mr-2 mb-1 md:mb-0">
                  Country Life Maxi-Zyme Extra Strength Capsules 60
								...
								<div className="mt-1 text-600">AED 90.30123</div>
							</div>
							<div className="mt-2 md:mt-0 ml-0 md:ml-8 flex align-items-center">
								<div
									className="surface-300 border-round overflow-hidden w-10rem lg:w-6rem"
						...
						<li className="flex flex-column md:flex-row md:align-items-center md:justify-content-between mb-4">
							<div>
                <span className="text-900 font-medium mr-2 mb-1 md:mb-0">
                  Now Curcumin 665 mg Veg Capsules 60
                </span>
								<div className="mt-1 text-600">AED 3.15</div>
							</div>
							<div className="mt-2 md:mt-0 ml-0 md:ml-8 flex align-items-center">
								<div
									className="surface-300 border-round overflow-hidden w-10rem lg:w-6rem"
			...
			<div className="col-12 xl:col-6">
                ...
                <span className="text-700">
                  {" "}
	                has purchased a Organic India Tulsi Breakfast Tea for{" "}
	                <span className="text-blue-500">AED 97.65123</span>
                </span>
              </span>
						</li>
                ...
                Your request for withdrawal of{" "}
								<span className="text-blue-500 font-medium">2500AED</span> has
                been initiated.
              </span>
						</li>
					</ul>
                ...
                <span className="text-700">
	                ...
	                has purchased a Natures Answer Licorice Root 2000 mg Fluid Extract Drops 30 mL for
	                <span className="text-blue-500">AED 27.30123</span>
                </span>
              </span>
						</li>
						<li className="flex align-items-center py-2 border-bottom-1 surface-border">
